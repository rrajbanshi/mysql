...
import com.examples.empapp.service.DaoServiceImpl;
...
//							empService.bulkExport();
	...
	private static void printStatistics() {
		...
		System.out.println("No of employees older than thirty years: "
				+ empDao.getEmployeeCountAgeGreaterThan(30));
		System.out.println("List employee IDs older than 30 years: " + empDao.getEmployeeIdsAgeGreaterThan());
		System.out.println("Employee count by Department: " + empDao.getEmployeeCountByDepartment());
		System.out.println("Employee count by Department ordered: " + empDao.getEmployeeCountByDepartmentOdered());
	}
